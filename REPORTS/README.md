...
| Fichier | Date | Description |
|---------|------|-------------|
| `REFACTORING_INGEST_FILE_UNIQUE_2025-12-08.md` | 2025-12-08 | ⭐ Consolidation IngestFile en fonction unique |
| `REFACTORING_INGEST_FILE_SUMMARY.md` | 2025-12-08 | Résumé du refactoring IngestFile |
| `REFACTORING_REMOVE_UNUSED_TIMESTAMPS_2025-12-08.md` | 2025-12-08 | ⭐ Suppression des timestamps inutilisés dans Fact et JoinResult |
