...
**📅 Date d'exécution:** 2025-11-18 18:18:16
...
2. **Student[S002]** - `Student[name=Bob, grade=45, active=true, id=S002]`
3. **Student[S003]** - `Student[id=S003, name=Charlie, grade=92, active=false]`
4. **Student[S004]** - `Student[grade=78, active=true, id=S004, name=Diana]`
5. **Course[C001]** - `Course[level=advanced, credits=4, id=C001, title=Advanced Math]`
6. **Course[C002]** - `Course[id=C002, title=Basic Physics, level=beginner, credits=2]`
7. **Course[C003]** - `Course[id=C003, title=Computer Science, level=advanced, credits=3]`
8. **Enrollment[EN001]** - `Enrollment[id=EN001, student_id=S001, course_id=C001, status=enrolled]`
9. **Enrollment[EN002]** - `Enrollment[id=EN002, student_id=S002, course_id=C002, status=failed]`
10. **Enrollment[EN003]** - `Enrollment[course_id=C001, status=dropped, id=EN003, student_id=S003]`
11. **Enrollment[EN004]** - `Enrollment[id=EN004, student_id=S004, course_id=C003, status=enrolled]`
...
##### Token combiné 1
- **`s`**: Student[S003] - `Student[name=Charlie, grade=92, active=false, id=S003]`
...
- **`c`**: Course[C002] - `Course[credits=2, id=C002, title=Basic Physics, level=beginner]`
- **Association:** Student[S001] ⋈ Course[C002]

##### Token combiné 3
- **`s`**: Student[S002] - `Student[name=Bob, grade=45, active=true, id=S002]`
...
- **`c`**: Course[C001] - `Course[level=advanced, credits=4, id=C001, title=Advanced Math]`
...
##### Token combiné 9
- **`s`**: Student[S003] - `Student[grade=92, active=false, id=S003, name=Charlie]`
- **`c`**: Course[C002] - `Course[credits=2, id=C002, title=Basic Physics, level=beginner]`
...
- **`c`**: Course[C003] - `Course[title=Computer Science, level=advanced, credits=3, id=C003]`
- **Association:** Student[S003] ⋈ Course[C003]
...
- **`c`**: Course[C001] - `Course[credits=4, id=C001, title=Advanced Math, level=advanced]`
- **Association:** Student[S004] ⋈ Course[C001]
...
2. **Customer[C002]** - `Customer[segment=standard, country=France, id=C002, name=Bob]`
...
8. **Payment[PY001]** - `Payment[status=completed, id=PY001, order_id=O001, method=credit_card]`
...
##### Token combiné 2
- **`c`**: Customer[C003] - `Customer[country=Germany, id=C003, name=Charlie, segment=premium]`
- **`o`**: Order[O002] - `Order[id=O002, customer_id=C002, amount=150, date=2024-01-02]`
- **Association:** Customer[C003] ⋈ Order[O002]

##### Token combiné 3
- **`c`**: Customer[C001] - `Customer[name=Alice, segment=premium, country=USA, id=C001]`
- **`o`**: Order[O003] - `Order[date=2024-01-03, id=O003, customer_id=C003, amount=800]`
...
##### Token combiné 6
- **`c`**: Customer[C003] - `Customer[name=Charlie, segment=premium, country=Germany, id=C003]`
...
**📋 Détail des faits parsés:**
1. **Person[P001]** - `Person[name=Alice, id=P001]`
...
2. **Person[P002]** - `Person[name=Bob, age=30, status=inactive, id=P002]`
3. **Person[P003]** - `Person[id=P003, name=Charlie, age=16, status=active]`
4. **Person[P004]** - `Person[id=P004, name=Diana, age=22, status=active]`
...
7. **Order[O003]** - `Order[id=O003, customer_id=P001, amount=200, status=confirmed]`
8. **Order[O004]** - `Order[id=O004, customer_id=P003, amount=300, status=confirmed]`
9. **Order[O005]** - `Order[customer_id=P004, amount=125, status=confirmed, id=O005]`
...
##### Token combiné 15
- **`p`**: Person[P003] - `Person[id=P003, name=Charlie, age=16, status=active]`
- **`o`**: Order[O003] - `Order[customer_id=P001, amount=200, status=confirmed, id=O003]`
...
- **`o`**: Order[O001] - `Order[status=confirmed, id=O001, customer_id=P001, amount=150]`
...
##### Token combiné 13
- **`p`**: Person[P001] - `Person[name=Alice, age=25, status=active, id=P001]`
- **`o`**: Order[O004] - `Order[amount=300, status=confirmed, id=O004, customer_id=P003]`
- **Association:** Person[P001] ⋈ Order[O004]
...
##### Token combiné 18
- **`p`**: Person[P002] - `Person[status=inactive, id=P002, name=Bob, age=30]`
- **`o`**: Order[O005] - `Order[status=confirmed, id=O005, customer_id=P004, amount=125]`
- **Association:** Person[P002] ⋈ Order[O005]
...
4. **Transaction[TXN001]** - `Transaction[amount=900, type=debit, id=TXN001, account_id=ACC001]`
5. **Transaction[TXN002]** - `Transaction[id=TXN002, account_id=ACC002, amount=1200, type=debit]`
6. **Transaction[TXN003]** - `Transaction[amount=600, type=debit, id=TXN003, account_id=ACC003]`
7. **Transaction[TXN004]** - `Transaction[id=TXN004, account_id=ACC001, amount=50, type=debit]`
...
##### Token combiné 12
- **`a`**: Account[ACC002] - `Account[credit_limit=1000, fees=5, id=ACC002, balance=2500]`
- **`t`**: Transaction[TXN004] - `Transaction[id=TXN004, account_id=ACC001, amount=50, type=debit]`
...
##### Token combiné 10
- **`a`**: Account[ACC003] - `Account[id=ACC003, balance=500, credit_limit=200, fees=15]`
- **`t`**: Transaction[TXN004] - `Transaction[type=debit, id=TXN004, account_id=ACC001, amount=50]`
- **Association:** Account[ACC003] ⋈ Transaction[TXN004]
...
##### Token combiné 5
- **`a`**: Account[ACC003] - `Account[balance=500, credit_limit=200, fees=15, id=ACC003]`
- **`t`**: Transaction[TXN003] - `Transaction[amount=600, type=debit, id=TXN003, account_id=ACC003]`
- **Association:** Account[ACC003] ⋈ Transaction[TXN003]

##### Token combiné 6
- **`a`**: Account[ACC003] - `Account[credit_limit=200, fees=15, id=ACC003, balance=500]`
- **`t`**: Transaction[TXN004] - `Transaction[id=TXN004, account_id=ACC001, amount=50, type=debit]`
- **Association:** Account[ACC003] ⋈ Transaction[TXN004]
...
2. **User[U002]** - `User[id=U002, name=Bob, score=60, created=1.7001e+09]`
...
7. **Activity[A004]** - `Activity[id=A004, user_id=U003, points=95, timestamp=1.7003e+09]`
...
**📋 Détail des faits parsés:**
1. **Product[PROD001]** - `Product[keywords=premium computer high-end, id=PROD001, name=Laptop, categories=electronics]`
...
4. **Review[R001]** - `Review[product_id=PROD001, rating=5, status=approved, id=R001]`
5. **Review[R002]** - `Review[id=R002, product_id=PROD002, rating=3, status=pending]`
6. **Review[R003]** - `Review[status=verified, id=R003, product_id=PROD001, rating=4]`
7. **Review[R004]** - `Review[id=R004, product_id=PROD003, rating=5, status=approved]`
...
##### Token combiné 10
- **`p`**: Product[PROD002] - `Product[name=Mouse, categories=accessories, keywords=basic cheap, id=PROD002]`
- **`r`**: Review[R004] - `Review[rating=5, status=approved, id=R004, product_id=PROD003]`
...
##### Token combiné 8
- **`p`**: Product[PROD001] - `Product[keywords=premium computer high-end, id=PROD001, name=Laptop, categories=electronics]`
- **`r`**: Review[R001] - `Review[id=R001, product_id=PROD001, rating=5, status=approved]`
- **Association:** Product[PROD001] ⋈ Review[R001]
...
2. **User[U002]** - `User[id=U002, name=Bob, role=lead, team_id=T001]`
3. **User[U003]** - `User[role=developer, team_id=T002, id=U003, name=Carol]`
4. **Team[T001]** - `Team[id=T001, name=Alpha, budget=10000, manager_id=U001]`
5. **Team[T002]** - `Team[id=T002, name=Beta, budget=5000, manager_id=U003]`
6. **Task[TASK001]** - `Task[priority=high, effort=50, id=TASK001, assignee_id=U002, team_id=T001]`
7. **Task[TASK002]** - `Task[team_id=T002, priority=medium, effort=20, id=TASK002, assignee_id=U003]`
8. **Task[TASK003]** - `Task[id=TASK003, assignee_id=U001, team_id=T001, priority=high, effort=30]`
...
- **`t`**: Team[T001] - `Team[name=Alpha, budget=10000, manager_id=U001, id=T001]`
...
- **`t`**: Task[TASK003] - `Task[effort=30, id=TASK003, assignee_id=U001, team_id=T001, priority=high]`
...
##### Token combiné 9
- **`u`**: User[U001] - `User[name=Alice, role=manager, team_id=T001, id=U001]`
- **`t`**: Team[T001] - `Team[budget=10000, manager_id=U001, id=T001, name=Alpha]`
- **Association:** User[U001] ⋈ Team[T001]
...
##### Token combiné 1
- **`u`**: User[U003] - `User[id=U003, name=Carol, role=developer, team_id=T002]`
- **`t`**: Task[TASK002] - `Task[priority=medium, effort=20, id=TASK002, assignee_id=U003, team_id=T002]`
- **Association:** User[U003] ⋈ Task[TASK002]
...
2. **Person[P002]** - `Person[id=P002, name=Bob, age=67, priority=normal]`
3. **Person[P003]** - `Person[id=P003, name=Charlie, age=35, priority=low]`
4. **Person[P004]** - `Person[name=Diana, age=19, priority=normal, id=P004]`
5. **Order[O001]** - `Order[customer_id=P001, amount=600, urgent=false, id=O001]`
...
8. **Order[O004]** - `Order[customer_id=P004, amount=50, urgent=false, id=O004]`
...
- **`o`**: Order[O004] - `Order[urgent=false, id=O004, customer_id=P004, amount=50]`
- **Association:** Person[P001] ⋈ Order[O004]
...
- **`o`**: Order[O004] - `Order[customer_id=P004, amount=50, urgent=false, id=O004]`
- **Association:** Person[P004] ⋈ Order[O004]
...
##### Token combiné 12
- **`p`**: Person[P003] - `Person[priority=low, id=P003, name=Charlie, age=35]`
- **`o`**: Order[O003] - `Order[urgent=true, id=O003, customer_id=P003, amount=100]`
- **Association:** Person[P003] ⋈ Order[O003]
...
##### Token combiné 5
- **`p`**: Person[P003] - `Person[age=35, priority=low, id=P003, name=Charlie]`
- **`o`**: Order[O001] - `Order[customer_id=P001, amount=600, urgent=false, id=O001]`
- **Association:** Person[P003] ⋈ Order[O001]
...
- **Token attendu 1:**
  * `p`: Person[P001] - `Person[age=25, id=P001, name=Alice]`
  * `o`: Order[O001] - `Order[id=O001, customer_id=P001, amount=100]`
- **Token attendu 2:**
...
**📋 Détail des faits parsés:**
1. **Employee[E001]** - `Employee[name=Alice, department=engineering, active=true, id=E001]`
2. **Employee[E002]** - `Employee[department=temp, active=true, id=E002, name=Bob]`
3. **Employee[E003]** - `Employee[department=marketing, active=false, id=E003, name=Charlie]`
...
6. **Project[P002]** - `Project[id=P002, lead_id=E002, status=cancelled, budget=2000]`
7. **Project[P003]** - `Project[status=completed, budget=800, id=P003, lead_id=E003]`
8. **Project[P004]** - `Project[id=P004, lead_id=E004, status=active, budget=1500]`
...
- **`p`**: Project[P003] - `Project[budget=800, id=P003, lead_id=E003, status=completed]`
...
##### Token combiné 10
- **`e`**: Employee[E004] - `Employee[active=true, id=E004, name=Diana, department=sales]`
- **`p`**: Project[P001] - `Project[id=P001, lead_id=E001, status=active, budget=5000]`
...
##### Token combiné 2
- **`e`**: Employee[E003] - `Employee[department=marketing, active=false, id=E003, name=Charlie]`
- **`p`**: Project[P001] - `Project[id=P001, lead_id=E001, status=active, budget=5000]`
- **Association:** Employee[E003] ⋈ Project[P001]
...
2. **Person[P002]** - `Person[active=false, id=P002, name=Bob]`
